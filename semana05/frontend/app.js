...
function limpiarFormEditar() {
  ...
  document.getElementById("editHint").textContent =
    "Haz clic en ✏️ de la tabla para editar un producto.";
...
document.getElementById("tabEditar").addEventListener("click", function () {
  switchTab("Editar");
});
document.getElementById("tabBuscar").addEventListener("click", function () {
  switchTab("Buscar");
});
